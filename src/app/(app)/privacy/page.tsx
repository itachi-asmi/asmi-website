	...
	return (
		<main className="mx-auto max-w-6xl px-6 pb-12 text-gray-800">
			...
			<section className="mt-10 space-y-8">
				...
				<p>
					Humint Labs, Inc. ("we," "our," or "us") values your privacy
					and is committed to protecting it. This Privacy Policy
					describes how we collect, use, store, and disclose your
					personal information when you use Asmi AI via WhatsApp,
					iMessage, our website or app.
				</p>
				<p>
					By using Asmi AI, you agree to the practices described in
					this Privacy Policy.
				</p>
				...
				<div>
					...
					<ul className="ml-4 list-inside list-disc">
						...
						<li>Calendar event data (Google, Outlook, Apple)</li>
						<li>
							Content shared with Asmi via WhatsApp (text, voice
							notes, images, and metadata)
						</li>
					</ul>
				</div>
				<div>
				...
				<div>
					<h3 className="font-semibold">C. Voice and Message Data</h3>
					<p>
						Voice notes and texts you send to Asmi are used to power
						memory, reminders, scheduling, and brief generation.
						These are processed and stored securely to improve user
						experience.
					</p>
				</div>
				...
				<ul className="ml-4 list-inside list-disc">
					...
					<li>Sync with calendar/contact apps per user permission</li>
					<li>
						Prevent abuse and ensure compliance with platform terms
					</li>
				</ul>
				...
				<ul className="ml-4 list-inside list-disc">
					<li>Infrastructure providers (e.g., AWS, Google Cloud)</li>
					<li>
				...
				<p>
					All integrations comply with Meta's, Google’s, and Apple’s
					developer terms.
				</p>
				...
				<ul className="ml-4 list-inside list-disc">
					...
					<li>WhatsApp messages processed via Meta’s secure APIs</li>
				</ul>

				<h2 className="text-2xl font-semibold">7. Data Retention</h2>
				<p>
					We retain personal data as long as your account is active or
					as needed to provide services. You may request deletion at
					any time.
				</p>
				...
				<p>
					...
					services, you consent to data being processed and stored in
					the U.S.
				</p>
				...
				<p>
					Asmi AI is not intended for individuals under 13. We do not
				...
				<ul className="ml-4 list-inside list-disc">
					...
					<li>Google, Outlook, and Apple API privacy requirements</li>
				</ul>
				...
				<p>
					...
					our website and/or communicated via WhatsApp.
				</p>
